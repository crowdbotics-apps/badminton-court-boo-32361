...
## Project Structure
    ...
    ├── badminton_court_boo_32361  # Django project configurations
...
1. Clone this repo and `cd badminton_court_boo_32361`
...
2. Clone this repo and `cd badminton_court_boo_32361`
